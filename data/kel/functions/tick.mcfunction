...
execute as @e[type=marker,tag=showcase1] at @s run function kel:removing

#interaction
execute as @e[type=interaction,tag=showcaseinteraction] at @s on target if score @s Sneaking_sc matches 0 run function kel:interaction/placeitem

#visiblenameswitch_sc
execute as @e[type=interaction,tag=showcaseinteraction,scores={visiblenameswitch_sc=0},tag=!displayinf] at @s run function kel:interaction/nameswitch

#type changer
execute as @e[type=interaction,tag=showcaseinteraction] at @s on target if score @s Sneaking_sc matches 1 run function kel:interaction/typechanger
