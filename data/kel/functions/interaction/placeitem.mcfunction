...
advancement grant @s only kel:sc_adv_2
execute if data entity @s SelectedItem{id:"minecraft:dragon_head"} run advancement grant @s only kel:sc_adv_3
execute if data entity @s SelectedItem{id:"minecraft:emerald"} run advancement grant @s only kel:sc_adv_4
execute if data entity @s SelectedItem{id:"minecraft:emerald_block"} run advancement grant @s only kel:sc_adv_4
execute if data entity @s SelectedItem{id:"minecraft:dragon_egg"} run advancement grant @s only kel:sc_adv_5
